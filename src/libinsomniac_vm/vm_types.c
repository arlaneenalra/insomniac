...
gc_type_def register_closure(gc_type *gc) {
    ...
    gc_register_pointer(
        gc, closure, offsetof(object_type, value) + offsetof(value_type, closure));
...
gc_type_def register_env(gc_type *gc) {
    ...
    gc_register_pointer(gc, env, offsetof(env_type, code_ref));
    gc_register_pointer(gc, env, offsetof(env_type, bindings));
    gc_register_pointer(gc, env, offsetof(env_type, parent));
...
gc_type_def create_vm_type(gc_type *gc) {
    ...
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, stack_root));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, empty));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, vm_true));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, vm_false));

    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, reg1));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, reg2));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, reg3));

    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, symbol_table));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, import_table));
    gc_register_pointer(gc, vm_type_def, offsetof(vm_internal_type, env));
